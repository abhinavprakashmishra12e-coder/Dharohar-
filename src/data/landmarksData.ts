import { Landmark } from '../types/heritage';
...
export const HERITAGE_LANDMARKS: Landmark[] = [
  {
    ...
    category: 'Mausoleum',
    keyHighlights: ['Central Onion Dome', 'Four 40m Minarets with Outward Tilt', 'Charbagh Water Reflecting Pools', 'Calligraphic Quranic Inscriptions'],
    elevationMeters: 171,
  },
  {
    id: 'golden-temple',
    ...
    category: 'Temple',
    keyHighlights: ['500kg Pure Gold Sanctum', 'Amrit Sarovar (Pool of Nectar)', '24-hour Guru Granth Sahib Kirtan', 'World’s Largest Community Kitchen (Langar)'],
    elevationMeters: 232,
  },
  {
    id: 'hawa-mahal',
    name: 'Hawa Mahal & Amber Fort',
    hindiName: 'हवा महल और आमेर का किला',
    stateId: 'rajasthan',
    stateName: 'Rajasthan',
    coords: { lat: 26.9239, lng: 75.8267 },
    mapPosition: { x: 195, y: 245 },
    yearBuilt: '1799 CE',
    ...
    keyHighlights: ['953 Intricately Carved Jharokhas', 'Honeycomb Cooling Aerodynamics', 'Sheesh Mahal (Palace of Mirrors) at Amber', 'Diwan-i-Aam & Maota Lake View'],
    elevationMeters: 431,
  },
  {
    id: 'meenakshi-temple',
    ...
    category: 'Temple',
    keyHighlights: ['14 Towering Sculpted Gopurams', 'Hall of Thousand Monolithic Pillars', 'Golden Lotus Sacred Tank (Potramarai Kulam)', 'Musical Pillars producing 7 Swaras'],
    elevationMeters: 136,
  },
  {
    ...
    category: 'Temple',
    keyHighlights: ['24 Astronomical Sundial Wheels', '7 Sculpted Chariot Horses of Dawn', 'Nata Mandira (Hall of Celestial Dancers)', 'Chlorite Stone Deities of Surya'],
    elevationMeters: 12,
  },
  {
    id: 'ellora-caves',
    ...
    coords: { lat: 20.0258, lng: 75.1780 },
    mapPosition: { x: 215, y: 450 },
    ...
    keyHighlights: ['Single Monolithic Basalt Cliff Carving', '200,000 Tonnes Hand-Excavated Rock', 'Life-Sized Stone Elephants & Stambhas', 'Ravana Shaking Mount Kailash Relief'],
    elevationMeters: 585,
  },
  {
    ...
    category: 'Memorial',
    keyHighlights: ['16-Foot Bronze Angel of Victory', '64 Acres of Mughal-British Water Gardens', 'White Makrana Marble Central Dome', 'Royal Gallery of Rare Historical Paintings'],
    elevationMeters: 9,
  },
  {
    id: 'varanasi-ghats',
    ...
    keyHighlights: ['Evening Grand Ganga Aarti at Dashashwamedh', 'Golden Shikhara of Kashi Vishwanath', 'Dawn Boat Rides across the Misty Ganga', 'Assi & Manikarnika Sacred Ghats'],
    elevationMeters: 80,
  }
];
